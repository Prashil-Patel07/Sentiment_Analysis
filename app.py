...
def run():
    ...
    with col1:
        ...
        if st.session_state.show_image1:
            st.image("https://www.theinsaneapp.com/wp-content/uploads/2024/10/Data-Science-Meme-7.png", caption="Image 1")
    ...
    with col2:
        ...
        if st.session_state.show_image2:
            st.image("https://www.atoti.io/wp-content/uploads/2024/06/1_t4zCD60p-dDd5BRmINW9tQ.webp", caption="Image 2")
